    ...
    content:
      ...
      items:
        - title: Undergraduate Researcher
          ...
          date_end: ''
          description: |2-
              Studied mechanism of enzyme-catalyzed reactions using quantum mechanics and molecule dynamics.
        - title: Undergraduate Researcher
        ...
        - title: Undergraduate Researcher
          ...
          * Mechanism study of non-canonical Ullmann coupling.
          * DFT calculation for Copper catalyst with significant multi-reference characters.
                    \item Developed system specific ACPs(Atom-Centered Potentials) for quantum dynamics and vibrational spectroscopy;
                        \item Applied database to delta machine learning.
